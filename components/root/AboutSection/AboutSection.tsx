    ...
    <div className="container mx-auto py-10 px-5">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        <motion.div
          ...
          viewport={{ once: true }}
          className="relative h-[400px] w-full overflow-visible" // Changed to overflow-visible
        >
          {/* Main Image */}
          <Image
          ...
          <motion.div
            ...
            className="absolute -right-5 -bottom-5 w-[45%] h-[60%]"
          >
            <div className="relative h-full w-full">
              ...
              />
              {/* Shadow effect to enhance 3D appearance */}
              <div className="absolute inset-0 rounded-lg shadow-[15px_15px_30px_rgba(0,0,0,0.3)] -z-10" />
            </div>

            {/* Tear effect at the connection point */}
            <div className="absolute -left-4 top-1/2 h-8 w-8 bg-white transform -translate-y-1/2 rotate-45 clip-tear" />
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            women&apos;s empowerment, skill development, and community
            growth—we&apos;ve transformed lives across The North Rift since
            2023. Last year alone, our programs provided scholarships, planted
            trees and fostered health education programs. Each initiative
            reflects our core belief: that empowered communities
