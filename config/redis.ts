...
export const SITE_SETTINGS_CACHE_TTL = 60 * 60 * 12;
export const SITE_CONTACT_DETAILS_CACHE_TTL = 60 * 60 * 12;
export const TESTIMONIAL_CACHE_TTL = 60 * 60 * 12;
export const TESTIMONIALS_CACHE_PREFIX = "testimonials";
