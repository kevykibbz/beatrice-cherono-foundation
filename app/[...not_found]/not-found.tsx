...
export default function NotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-gray-900 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              <h1 className="text-7xl md:text-8xl font-bold mb-4 text-purple-500">404</h1>
              <h2 className="text-3xl font-bold mb-4">UH OH! You&apos;re lost.</h2>
              ...
              <Link
                href="/"
                className="relative z-10 overflow-hidden inline-block px-12 py-2 rounded-full border-2 border-purple-500 font-bold transition-colors duration-200 hover:text-white hover:bg-purple-500"
              >
                HOME
              </Link>
            </div>
